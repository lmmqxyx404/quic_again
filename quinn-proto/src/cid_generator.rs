...
pub trait ConnectionIdGenerator: Send {
    ...
    /// 2. Returns the length of a CID for connections created by this generator
    fn cid_len(&self) -> usize;
    /// 3. Returns the lifetime of generated Connection IDs
    ///
    /// Connection IDs will be retired after the returned `Duration`, if any. Assumed to be constant.
    fn cid_lifetime(&self) -> Option<Duration>;
    /// 4. Quickly determine whether `cid` could have been generated by this generator
    ///
